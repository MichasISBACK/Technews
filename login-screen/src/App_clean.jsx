    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-slate-800 border border-slate-700 rounded-lg shadow-xl p-8">
          ...
          {/* OAuth Buttons - Only show on login and signup forms */}
          {!isForgotPassword && (
            <>
                ...
                <>
                  <div className="relative my-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 bg-slate-800 text-slate-400" style={{fontFamily: 'Inter, system-ui, sans-serif'}}>
                        Ou continue com
                      </span>
                    </div>
                  </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-slate-400 text-sm" style={{fontFamily: 'Inter, system-ui, sans-serif'}}>
                  ...
                  <button
                    ...
                    className="text-blue-400 hover:text-blue-300 transition-colors ml-1 font-medium"
                    style={{fontFamily: 'Inter, system-ui, sans-serif'}}
                  >
